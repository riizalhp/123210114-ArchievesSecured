...
<div class="container">
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <center>
            <form action="foto-stegano.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <p style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">
                <br>
            <center>Please enter the message you want to insert.
                <br>
            </center>
            <br>
                <div class="mb-3">
                    ...
                    <input type="text" name="pesan" id="pesan" class="form-control" cols="50" required>
                </div>
                <input type="submit" value="Upload Foto" class="btn btn-dark">
            </form>
        </center>
    </div>
    <div class="container">
